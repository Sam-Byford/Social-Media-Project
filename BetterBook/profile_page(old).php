			...
			<div id="Banner">
				<?php 
					if($profileData['university'] == 'University of Lincoln') {
						echo '<img id="BannerImage" src="assets/uniBanners/lincoln.jpg" alt="The University of Lincoln">';
					} else if ($profileData['university'] == 'University of Nottingham') {
						echo '<img id="BannerImage" src="assets/uniBanners/nottingham.jpg" alt="The University of Nottingham">';
					} else if ($profileData['university'] == 'University of Derby') {
						echo '<img id="BannerImage" src="assets/uniBanners/derby.jpg" alt="The University of Derby">';
					}
							...
							if ($posts->num_rows > 0) {
			                    foreach($posts as $post) {
			                    	...
			                    	<div class="card" style="width: 300%"; margin-left: 50%;>
									  ...
									  <div class="card-body">
									  	<p>
									  		' .$post['post_author'] . '<br>'. $post['post_text'] . '<br>' . date('d/m/y H:i:s', strtotime($post['post_date'])) . '
									  	</p>
									  </div>
									</div>
			                    ';
